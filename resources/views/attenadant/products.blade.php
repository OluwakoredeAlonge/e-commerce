...
<head>
  ...
  <title>Products - E-Commerce POS</title>
      ...
      <div class="container mx-auto flex justify-between items-center">
        ...
        <nav>
          <ul class="flex space-x-4">
            <li><a href="overview.html" class="hover:underline">Dashboard</a></li>
            <li><a href="process-sale.html" class="hover:underline">Process Sale</a></li>
            <li><a href="products.html" class="hover:underline font-semibold">Products</a></li>
            <li><a href="orders.html" class="hover:underline">Orders</a></li>
            <li><a href="sales.html" class="hover:underline">Sales History</a></li>
  ...
  <script>
    ...
    async function fetchProducts() {
      products = [
        ...
        { id: 5, name: 'T-Shirt', category: 'Clothing', price: 2999, stock_quantity: 50 },
      ];
    ...
    function renderProductTable(list) {
      ...
      productTable.innerHTML = list.length === 0
        ? `<tr><td colspan="4" class="px-4 py-2 text-center text-gray-500">No products found</td></tr>`
        : list.map(p => `
          <tr class="${p.stock_quantity < 10 ? 'text-red-600' : ''}">
