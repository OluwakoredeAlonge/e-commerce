<!DOCTYPE html>
<html lang="en" x-data="{ showLogin: false, showPassword: false, role: '' }">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>POS Landing - E-Commerce POS</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <script defer src="https://cdn.jsdelivr.net/npm/alpinejs@3.x.x/dist/cdn.min.js"></script>
</head>
<body class="bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 min-h-screen flex flex-col items-center justify-center font-sans">
    ...
    <div class="text-center text-white mb-10">
        ...
        <h1 class="text-4xl font-bold">E-Commerce POS</h1>
        <p class="text-lg opacity-90">Fast & Reliable Point of Sale for Your Store</p>
    </div>

    <!-- Role Selection Buttons -->
    <div class="flex space-x-6">
        <button @click="showLogin = true; role = 'superadmin'" 
            class="bg-white text-blue-700 font-semibold py-3 px-6 rounded-lg shadow-lg hover:bg-blue-100 transition">
            Admin Login
        </button>
        <button @click="showLogin = true; role = 'attendant'" 
            class="bg-white text-purple-700 font-semibold py-3 px-6 rounded-lg shadow-lg hover:bg-purple-100 transition">
            Attendant Login
        </button>
    </div>
    ...
    <div x-show="showLogin" 
        ...
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-8 relative">
            ...
            <div class="flex flex-col items-center mb-6">
                ...
                <h1 class="text-2xl font-bold text-gray-800" x-text="role + ' Login'"></h1>
