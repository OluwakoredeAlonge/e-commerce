...
@section('content')
    ...
    <div class="flex-1 p-6">
      ...
      <div class="bg-white shadow-lg rounded-lg p-6 mb-6 border-l-4 border-green-500">
        <div class="flex items-center space-x-4">
          <svg class="w-10 h-10 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path></svg>
          <div>
        ...
        <div class="mt-4">
          <a href="products.html" class="text-green-600 hover:text-green-800 font-medium">Manage Products</a>
        </div>
      </div>
      ...
      <div class="mb-6 flex flex-col md:flex-row gap-4">
        <div class="relative flex-1">
          <input type="text" id="productSearch" placeholder="Search by product name or category..." class="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
        ...
        <table class="min-w-full">
          ...
          <tbody id="productTable" class="divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Low Stock</td>
             
            </tr>
            <tr class="hover:bg-gray-50">
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">USB-C Cable</td>
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Accessories</td>
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">₦22,500</td>
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">0</td>
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Out of Stock</td>
  ...
  <script>
    // Sample data for client-side filtering (products with stock < 10)
    const productData = [
      { name: 'Wireless Mouse', category: 'Accessories', price: '₦45,000', stock: 8, status: 'Low Stock' },
      { name: 'USB-C Cable', category: 'Accessories', price: '₦22,500', stock: 0, status: 'Out of Stock' },
    ];
