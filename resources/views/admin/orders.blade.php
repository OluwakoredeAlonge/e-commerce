    ...
    <div class="flex-1 p-6">
      <div class="flex justify-between items-center mb-6">
        <div>
          ...
          <p class="text-sm text-gray-500">View and manage all customer orders with detailed product information in details view.</p>
        </div>
      ...
      <div class="mb-6 flex flex-col md:flex-row gap-4">
        <div class="relative flex-1">
          <input type="text" id="orderSearch" x-model="searchTerm" placeholder="Search by customer or order ID..." class="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
            ...
            <template x-for="order in filteredOrders" :key="order.id">
              <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm">
                  <button class="view-details text-green-600 hover:text-green-800" :data-order-id="order.id">View Details</button>
                </td>
              </tr>
            </template>
          </tbody>
